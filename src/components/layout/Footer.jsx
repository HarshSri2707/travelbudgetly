...
export const Footer = () => {
  const footerLinks = {
    ...
    travelStyle: [
      ...
      { label: 'Budget Travel', path: '/travel-style/backpacking' },
    ],
    company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Your trusted travel partner for exploring India's incredible beauty, safely and affordably.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-primary-600 flex items-center justify-center transition-colors">
          ...
          <div>
            <h3 className="font-semibold text-white mb-4">Travel Style</h3>
            <ul className="space-y-2">
              {footerLinks.travelStyle.map((link) => (
                <li key={link.label}>
                  <Link to={link.path} className="text-sm hover:text-primary-400 transition-colors">
                    {link.label}
                  </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © 2025 TravelBudgetly. All rights reserved.
            </p>
