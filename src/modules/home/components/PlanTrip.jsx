...
export const PlanTrip = () => {
  ...
  return (
    <section ref={ref} className="py-20 bg-blue-50/50 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">

        {/* ── Heading — no watermark in this section ──────────────── */}
        <div className="text-center mb-16">
          <h2 className="font-bold text-3xl md:text-4xl text-gray-900 mb-4">
            Plan your Trip With US
          </h2>
        ...
        >
          ...
          >
            ...
            <button className="w-full bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold py-5 rounded-full transition-all duration-300 mt-4 shadow-lg shadow-blue-200 text-sm uppercase tracking-wider">
              Find My Perfect Trip
            </button>
          </motion.div>
        </motion.div>
