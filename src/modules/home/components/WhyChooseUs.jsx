    ...
    <section ref={ref} className="py-20 bg-gray-50 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative text-center mb-10">
          <span className="absolute inset-x-0 top-1/2 -translate-y-1/2 text-[32px] md:text-[80px] font-black tracking-widest select-none pointer-events-none text-gray-900/[0.05] whitespace-nowrap">
            WHY CHOOSE US
          </span>
